...
if __name__ == '__main__':
    ...
    results = model.predict(
        ...
        stream_buffer=False, # 是否对接收到的视频流帧进行排队。如果为 False，旧帧会被丢弃，以容纳新帧（针对实时应用进行了优化）。如果为 True，则在缓冲区中排队等待新帧，确保不会跳过任何帧，但如果推理的 FPS 低于流的 FPS，则会导致延迟。
        ...
        project="/Users/autumn/IdeaProjects/ultralytics/ultralytics/yolo_workspace/test_output",  # 保存预测结果的项目目录名称，如果 `save` 已启用。
